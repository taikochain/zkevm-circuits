...
impl MockTransaction {
    ...
    /// Set enable_invalid_tx field for the MockTransaction.
    pub fn enable_invalid_tx(&mut self, enable_invalid_tx: bool) -> &mut Self {
        self.enable_invalid_tx = enable_invalid_tx;
        self
    }
