...
def prepare_result_dataframe(prover, degree, logfile, test_result, sysstat,env, test_id, instance_commitments, instance_evaluations, advice_commitments, advice_evaluations, fixed_commitments, fixed_evaluations, lookups_commitments, lookups_evaluations, equality_commitments, equality_evaluations, vanishing_commitments, vanishing_evaluations, multiopen_commitments, multiopen_evaluations, polycom_commitments, polycom_evaluations, circuit_cost, minimum_rows, blinding_factors, gates_count):
    ...
    try:
        r = {
            ...
            'advice_evaluations'     : advice_evaluations,
            'fixed_commitments'      : fixed_commitments,
            'fixed_evaluations'      : fixed_evaluations,
            'lookups_commitments'    : lookups_commitments,
            'lookups_evaluations'    : lookups_evaluations,
            'equality_commitments'  : equality_commitments,
            'equality_evaluations'  : equality_evaluations,
            'vanishing_commitments'  : vanishing_commitments,
            'vanishing_evaluations'  : vanishing_evaluations,
            'multiopen_commitments'   : multiopen_commitments,
            'multiopen_evaluations'   : multiopen_evaluations,
            'polycom_commitments'    : polycom_commitments,
            'polycom_evaluations'    : polycom_evaluations,
...
def log_processor(pull_request, degree):
    '''
