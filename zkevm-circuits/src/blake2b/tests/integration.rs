...
// No "compress_contract_vector_1" and "compress_contract_vector_2 because in these cases the input length 
// is not equal to 213 bytes, while the "contract" function has the input parameter of the "&[u8; 213]" type.
...
#[test]
#[ignore] // Large computation cost because in this case the number of rounds is 2^32 - 1.  
